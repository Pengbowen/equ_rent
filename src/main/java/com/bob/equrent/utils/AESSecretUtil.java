package com.bob.equrent.utils;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.StrUtil;
import com.bob.equrent.constant.SecretConstant;
...
public class AESSecretUtil {
    ...
    public static String encryptToStr(String data, String key) {
        ...
        return StrUtil.isNotBlank(data) ? parseByte2HexStr(encrypt(data, key)) : null;
    }
    ...
    public static String decryptToStr(String enCryptdata, String key) {
        return StrUtil.isNotBlank(enCryptdata) ? new String(decrypt(parseHexStr2Byte(enCryptdata), key)) : null;
    }
